...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen  bg-cover bg-center p-8 flex flex-col items-center">
      {/* Hero Section */}
      ...
      <div className="w-full max-w-6xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 w-full">
          {products.map((product, index) => (
            product.category === 'gaming' && <div key={index} className="group cursor-pointer">
      ...
      <div className="w-full max-w-6xl bg-purple-700 text-white p-8 rounded-lg shadow-lg mt-12 text-center">
        ...
        <div className="flex flex-col gap-2 md:flex-row max-w-md mx-auto">
          ...
          />
          <button className="bg-gray-800 cursor-pointer text-white font-medium py-3 px-6 rounded-r-lg hover:bg-gray-900 transition-colors duration-300">
            Subscribe
          </button>
        </div>
      </div>
